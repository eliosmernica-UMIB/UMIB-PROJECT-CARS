    ...
    initializeDefaultInventory: function() {
        ...
        const defaultCars = [
            ...
            },
            {
                ...
                description: 'One of the most iconic classics ever made - extremely rare and collectible.',
                category: 'Classic',
                speed: '174 mph',
                acceleration: '5.5s',
                engine: '3.0L V12',
            ...
            },
            {
                ...
                description: 'A top-tier convertible supercar with a roaring V10 and jaw-dropping performance.',
                category: 'Supercar',
                speed: '325 km/h',
                acceleration: '2.9s',
                engine: '5.2L V10',
            ...
            },
            {
                ...
                description: 'Born on the track, built for the road. Precision handling and thrilling power.',
                category: 'Sports',
                speed: '318 km/h',
                acceleration: '3.2s',
                engine: '4.0L Flat-6',
            ...
            },
            {
                ...
                description: 'A track-focused V8 Ferrari with stunning downforce and blistering acceleration.',
                category: 'Supercar',
                speed: '340 km/h',
                acceleration: '2.85s',
            ...
            },
            {
                ...
                description: 'The first V12 hybrid from Lamborghini - fierce power and futuristic design.',
                category: 'Hypercar',
                speed: '217 mph',
                acceleration: '2.2s',
                engine: 'V12 Hybrid',
        ...
        defaultCars.forEach(car => this.addCar(car));
        ...
        const defaultRentalCars = [
            {
                ...
                dailyRate: 1500,
                image: 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&q=80&w=800',
                description: 'Experience the thrill of a track-ready Porsche.',
                category: 'Sports',
                seats: 2,
                transmission: 'PDK',
                status: 'available'
            },
            {
                ...
                dailyRate: 2500,
                image: 'https://images.unsplash.com/photo-1566024164372-0281f1133aa6?auto=format&fit=crop&q=80&w=800',
                description: 'A classic icon with legendary gullwing doors.',
                category: 'Classic',
                seats: 2,
                transmission: 'Manual',
                status: 'available'
        ...
        defaultRentalCars.forEach(car => this.addRentalCar(car));
        
        // Default car parts
        const defaultParts = [
            {
                name: 'Brembo GT Ceramic Brakes',
                price: 12500,
                image: 'img/1.1.png',
                description: 'Professional-grade ceramic brake system for high-performance vehicles.',
                category: 'Brakes',
            ...
            {
                name: 'Vossen Forged Wheels (Set)',
                price: 6400,
                image: 'img/3.1.png',
                description: 'Premium forged aluminum wheels with custom finish.',
                category: 'Wheels',
                compatibility: 'Universal',
                quantity: 8,
                status: 'in-stock'
            ...
            {
                name: 'Twin Turbo Upgrade Kit',
                price: 25000,
                image: 'img/4.1.png',
                description: 'Complete twin turbo system for significant power gains.',
                category: 'Engine',
                compatibility: 'Various V8 engines',
                quantity: 3,
                status: 'in-stock'
            },
            {
                ...
                price: 15000,
                image: 'img/5.1.png',
                description: 'Full carbon fiber body kit including front splitter and rear diffuser.',
                category: 'Body',
                compatibility: 'Porsche 911',
                quantity: 4,
                status: 'in-stock'
            },
            {
                ...
                price: 4500,
                image: 'img/6.1.png',
                description: 'Adjustable coilover suspension for track and street.',
                category: 'Suspension',
                compatibility: 'Universal',
                quantity: 12,
                status: 'in-stock'
        ...
        defaultParts.forEach(part => this.addCarPart(part));
